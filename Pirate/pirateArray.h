#ifndef _PIRATE_ARRAY_H_
#define _PIRATE_ARRAY_H_
...
*/
template <class T, typename TAlloc = AllocatorDefault<T> >
class array
{
...
public:
	...
	T& getLast()
	{
		_PIRATE_DEBUG_BREAK_IF(!used) // access violation
	...
	{
		_PIRATE_DEBUG_BREAK_IF(index>=used || count<1 || index+count>used) // access violation
